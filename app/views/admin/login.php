...
<head>
    ...
    <link href="<?php echo URLROOT; ?>/admin/css/sb-admin-2.min.css" rel="stylesheet">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="<?php echo URLROOT; ?>/admins/login" method="post">
                                    <div class="form-group">
                                        <input type="text" name="username" class="form-control form-control-user <?php echo (!empty($data['username_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['username'];?>"
                                               id="exampleInputEmail" aria-describedby="emailHelp"
                                               placeholder="Enter Email Address...">
                                        <span class="invalid-feedback"><?php echo $data['username_err'];?></span>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control form-control-user <?php echo (!empty($data['password_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['password'];?>"
                                ...
                                <div class="text-center">
                                    <a class="small" href="forgot-password.html" style="">Forgot Password?</a>
                                </div>
                                <div class="text-center">
